<?php
require_once "FlashPay.Exception.php";
require_once "FlashPay.Config.php";
require_once "FlashPay.Data.php";
...
class FlashPayApi
{
     ...
     * @param FlashPayMicropayOrder $inputObj
     * @param int $timeOut
     * @throws FlashPayException
     * @return $result 成功时返回，其他抛异常
     */
     ...
     * @param FlashPayRetailQRCode $inputObj
     * @param int $timeOut
     * @throws FlashPayException
     * @return $result 成功时返回，其他抛异常
     */
     ...
     * @param FlashPayOrderQuery $inputObj
     * @param int $timeOut
     * @throws FlashPayException
     * @return $result 成功时返回，其他抛异常
     */
     ...
     * @param FlashPayApplyRefund $inputObj
     * @param int $timeOut
     * @throws FlashPayException
     * @return $result 成功时返回，其他抛异常
     */
     ...
     * @param FlashPayQueryRefund $inputObj
     * @param int $timeOut
     * @throws FlashPayException
     * @return $result 成功时返回，其他抛异常
     */
     ...
     * @param FlashPayQueryOrders $inputObj
     * @param int $timeOut
     * @throws FlashPayException
     * @return $result 成功时返回，其他抛异常
     */
    ...
    private static function getJsonCurl($url, $inputObj, $second = 30)
    {
        ...
        //如果有配置代理这里就设置代理
        if (FlashPayConfig::CURL_PROXY_HOST != "0.0.0.0"
            && FlashPayConfig::CURL_PROXY_PORT != 0
        ) {
            curl_setopt($ch, CURLOPT_PROXY, FlashPayConfig::CURL_PROXY_HOST);
            curl_setopt($ch, CURLOPT_PROXYPORT, FlashPayConfig::CURL_PROXY_PORT);
        }
        ...
        if ($data) {
            ...
            $error = curl_errno($ch);
            curl_close($ch);
            throw new FlashPayException("curl出错，错误码:$error");
        }
    }
